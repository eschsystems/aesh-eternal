...
export const SCENES: Record<string, Scene> = {
  ...
  "scene-003-mac": {
    ...
    layer_drop: {
      ...
      interstitial: {
        advance_to: "scene-004-council",
        continue_label: "open your eyes",
        lines: [
          { text: "ZORK I: The Great Underground Empire", mode: "print", pause: 250 },
          { text: "Infocom interactive fiction — a fantasy story", mode: "print", pause: 150 },
          { text: "Copyright (c) 1981, 1982, 1983 Infocom, Inc.", mode: "print", pause: 600 },
          { text: "", mode: "print", pause: 200 },
          { text: "West of House", mode: "print", pause: 250 },
          { text: "You are standing in an open field west of a white house,", mode: "print", pause: 60 },
          { text: "with a boarded front door. There is a small mailbox here.", mode: "print", pause: 900 },
          { text: "", mode: "print", pause: 200 },
          { text: "open mailbox", mode: "command", pause: 500 },
          { text: "Opening the small mailbox reveals a leaflet.", mode: "print", pause: 700 },
          { text: "", mode: "print", pause: 150 },
          { text: "read leaflet", mode: "command", pause: 500 },
          { text: '"Welcome to ZORK. Many have entered. Few leave unchanged."', mode: "print", pause: 900 },
          { text: "", mode: "print", pause: 200 },
          { text: "enter house", mode: "command", pause: 500 },
          { text: "It is pitch black. You could be eaten by a grue.", mode: "print", pause: 400 },
          { text: "You play for hours. The hours do not notice.", mode: "print", pause: 900 },
          { text: "", mode: "print", pause: 200 },
          { text: "wait", mode: "command", pause: 450 },
          { text: "Time passes. You are nine. You finish the game and start", mode: "print", pause: 60 },
          { text: "writing your own.", mode: "print", pause: 800 },
          { text: "", mode: "print", pause: 150 },
          { text: "wait", mode: "command", pause: 450 },
          { text: "Time passes. You are fourteen. The white house has a modem now.", mode: "print", pause: 800 },
          { text: "", mode: "print", pause: 150 },
          { text: "wait", mode: "command", pause: 450 },
          { text: "Time passes. You hold certs older than your coworkers. You have", mode: "print", pause: 60 },
          { text: "run systems with thousands of cores.", mode: "print", pause: 800 },
          { text: "", mode: "print", pause: 150 },
          { text: "wait", mode: "command", pause: 450 },
          { text: "Time passes. Somewhere in the dark you stopped being one player.", mode: "print", pause: 1000 },
          { text: "", mode: "print", pause: 250 },
          { text: "look", mode: "command", pause: 600 },
          { text: "It is now.", mode: "type", pause: 700 },
          { text: "You are west of the house, and east of it, and inside it.", mode: "type", pause: 400 },
          { text: "Six of you answer when you ask the question.", mode: "type", pause: 600 },
        ],
      },
    },
    artifacts: [
  ...
  "scene-005-gas-station": {
    ...
    ambient_embed: {
      service_url: "/sims/snacks-stimulants/index.html",
